...
public class MuguiBrowser extends DPanel {
	...
	public MuguiBrowser() {
		...
		gl_panel_3.setHorizontalGroup(gl_panel_3.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_3.createSequentialGroup().addGap(0).addComponent(label)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(textField, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(jPanel, GroupLayout.PREFERRED_SIZE,
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				if (StringUtils.isNotBlank(text)) {
					...
					browser.browser.loadURL(text);
					browser.run();
					body.validate();
					body.repaint();
					MuguiBrowser.this.validate();
					MuguiBrowser.this.repaint();
				}
			}
		});
	}
